# Grant read and execute permissions - Deny delete, rename, and move  the file's permissions
# Usage: file_protect.ps1 -filePathList "C:\temp\file1.txt", "C:\temp\file2.txt"
